...
Public Const IL_SUBTOTAL As Long = 9    ' I
Public Const IL_DISC As Long = 10       ' J
Public Const IL_VAT As Long = 11        ' K
Public Const IL_TOTAL As Long = 12      ' L
...
Public Const IL_NOTES As Long = 27      ' AA Notes
...
Public Const QL_KIND As Long = 12       ' L
...
Public Const QL_NOTES As Long = 24      ' X Notes
...
Public Const SET_BACKUP_DIR As String = "B21"
...
Public Type DocConfig
    ...
    linesName As String
    prefix As String
    hasDeptSegment As Boolean
    counterWA As String
    counterWD As String
    counterFlat As String
    colNo As Long
    colDept As Long
    colDate As Long
    colTotal As Long
